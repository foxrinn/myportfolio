...
public class AddLessonStudentController {
    public ComboBox<Teacher> teachersComboBox;
    ...
    public void initialize() {
        try {
            ...
            teachersComboBox.setItems(FXCollections.observableList(teachers));
                    ...
                    return new DateCell() {
                        public void updateItem(LocalDate item, boolean empty) {
                            try {
                                ...
                                List<WorkDaySchedule> list = workDayScheduleRepository.getByTeacher(teachersComboBox.getSelectionModel().getSelectedItem().getId());
        ...
        try {
            if (datePicker.getValue() != null) {
                if (teachersComboBox.getSelectionModel().getSelectedItem() != null) {
                    ...
                    List<LocalTime> localTimeList = lessonRepository.get(teachersComboBox.getSelectionModel().getSelectedItem().getId(), datePicker.getValue());
    ...
    public void addTraining(ActionEvent actionEvent) {
        try {
            if (teachersComboBox.getSelectionModel().getSelectedItem() != null && datePicker.getValue() != null
                ...
                lessonRepository.post(lesson, teachersComboBox.getSelectionModel().getSelectedItem().getId(), this.value.getId(), subjectsComboBox.getSelectionModel().getSelectedItem().getId());
